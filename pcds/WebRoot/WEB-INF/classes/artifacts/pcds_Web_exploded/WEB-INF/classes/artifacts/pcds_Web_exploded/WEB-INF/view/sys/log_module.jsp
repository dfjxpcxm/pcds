...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/public/scripts/ext3.4.0/ext-all.gzjs"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/sys/scripts/log_module_layout.js"></script>
  </head>
  
  <body onload="loadGraph()">
    <iframe id="chartframe1" name="chartframe1" style="width:100%;height: 100%;background-color:white;overflow:hidden;border:0px;" frameborder="0"></iframe>
    <iframe id="chartframe2" name="chartframe2" style="width:100%;height: 100%;background-color:white;overflow:hidden;border:0px;" frameborder="0"></iframe>
  </body>
  	<script type="text/javascript">

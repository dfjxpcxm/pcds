...
<html>
	<head>
		...
		<script type="text/javascript"src="<%= path %>/static/meta/js/column_biz_type_layout.js"></script>
		<script type="text/javascript"src="<%= path %>/static/meta/js/column_biz_type_ctrl.js"></script>
	</head>
	<body>
	<div id="center"></div>
	</body>

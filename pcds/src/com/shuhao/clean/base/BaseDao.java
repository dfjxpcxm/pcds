...
import static com.shuhao.clean.utils.GlobalUtil.lowercaseListMapKey;
import static com.shuhao.clean.utils.GlobalUtil.lowercaseMapKey;
...
public abstract class BaseDao {
	...
	protected void batchUpdate(final String[] sqlArray) throws Exception {
		if(sqlArray.length>0){
			...
			if (!"success".equals(exeRs)) {
				Exception e = new Exception(String.valueOf(exeRs));
				throw  e;
			}
		}else{
			logger.error("批量执行sql列表为空.");
		}
	}
	 ...
	 * @throws Exception
	 */
	protected List<Object> queryForList(String sql, Class<Object> cls) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected PageResult<Map<String, Object>> pageQueryInInformixWay(String sql,String countSql, PageRange range) throws Exception {
		...
		pageResult.setResults( jdbcTemplate.queryForList(pageSql));
	 ...
	 * @throws Exception
	 */
	protected PageResult<Map<String, Object>> pageQueryInOracleWay(String sql, PageRange range) throws Exception {
		PageResult<Map<String, Object>> pageResult = new PageResult<Map<String, Object>>();
		...
		List<Map<String, Object>> dataList = this.jdbcTemplate.query(pageSql, new Object[] { range.getStart() + 1,
				range.getStart() + range.getLimit() }, new RowMapper<Map<String, Object>>() {
		...
		pageResult.setResults(dataList);
		return pageResult;
	}

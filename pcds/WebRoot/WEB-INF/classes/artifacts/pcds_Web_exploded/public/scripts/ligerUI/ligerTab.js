...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.tab.links = $('<div class="l-tab-links"><ul style="left: 5px; "></ul></div>');
            ...
            g.tab.bind('dblclick.tab', function (e)
            {
                ...
                if (tagName == "a")
                {
                    var tabid = $(obj).parent().parent().attr("tabid");
                    var allowClose = $(obj).parent().parent().find("div.l-tab-links-item-close").length ? true : false;
                    if (allowClose)
                    {
        ...
        selectTabItem: function (tabid)
        {
            ...
            $("> .l-tab-content-item[tabid=" + tabid + "]", g.tab.content).show().siblings().hide();
             ///////////////样式更改
            var t_ul = $("li[tabid=" + tabid + "]", g.tab.links.ul);
            t_ul.addClass("l-selected").siblings().removeClass("l-selected"); 
            $('.l-tab-links-item-left',t_ul).addClass('l-tab-left-selected');
            $('.l-tab-links-item-right',t_ul).addClass('l-tab-right-selected');
            $('.l-tab-links-item-close',t_ul).removeClass('l-tab-links-item-close-blur');
            $('.l-tab-links-item-left',t_ul.addClass("l-selected").siblings()).removeClass('l-tab-left-selected');
            $('.l-tab-links-item-right',t_ul.addClass("l-selected").siblings()).removeClass('l-tab-right-selected');
            $('.l-tab-links-item-close',t_ul.addClass("l-selected").siblings()).addClass('l-tab-links-item-close-blur');
        ...
        addTabItem: function (options)
        {
            ...
            var tabitem = $("<li><div style = 'text-align:left;padding-left:20px;'><a></a></div><div class='l-tab-links-item-left'></div><div class='l-tab-links-item-right'></div><div class='l-tab-links-item-close'></div></li>");
        ...
        removeTabItem: function (tabid)
        {
            ...
            if (currentIsSelected)
            {
                ...
                var t_ul = $("li[tabid=" + tabid + "]", g.tab.links.ul).prev()
                t_ul.addClass("l-selected").siblings().removeClass("l-selected");
                ////////////样式更改增加代码
                $('.l-tab-links-item-left',t_ul).addClass('l-tab-left-selected');
	            $('.l-tab-links-item-right',t_ul).addClass('l-tab-right-selected');

...
//		alert((currKey == 8) && (e.srcElement.tagName == "TEXTAREA" || e.srcElement.tagName == "INPUT")&&(e.srcElement.readOnly==true||e.srcElement.disabled==true));
		if ((currKey == 8) && (e.srcElement.tagName == "TEXTAREA" || e.srcElement.tagName == "INPUT")&&(e.srcElement.readOnly==true||e.srcElement.disabled==true))
		{
			return false;
		}
